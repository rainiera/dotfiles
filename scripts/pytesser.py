# Not my work, this is Robin David's work:
# https://github.com/RobinDavid/Pytesser

# I just added an f.close() after the f.read() line in the image_to_string
# function to avoid a minor memory leak.

# See the docstring in ocr.py for how to use this.
